...
<html lang="en">
    <head>
        ...
        <title>Homies Fine Arts - About Us</title>
    ...
    <body>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <div class="d-flex gap-2">
                        <?php if (isset($_SESSION['user_id'])): ?>
                            <a href="web/public/dashboard.php" class="btn btn-primary">
                                <i class="bi bi-person-circle"></i> My Account
                            </a>
                        <?php else: ?>
                            <a href="web/public/login.php" class="btn btn-primary">
        ...
        <footer class="bg-dark text-white py-4 mt-5">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <h5>Homies Fine Arts</h5>
                        <p>Creating confusion since 2025</p>
                    </div>
